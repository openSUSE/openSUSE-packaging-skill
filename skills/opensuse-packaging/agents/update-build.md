...
6. **Write the `.changes`**: curated user-facing bullets, exact filenames for dropped patches/sources, full CVE IDs, insertion-only (never touch an entry below yours).
